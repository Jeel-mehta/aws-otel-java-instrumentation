...
import com.aws_lambda_xray.opentelemetry.exporter.otlp.OtlpUdpSpanExporterBuilder;
...
public class ManualApp extends BaseApp {
    ...
    private static OpenTelemetry buildOpentelemetry() {
        ...
        final String udpExporter = System.getenv().getOrDefault("OTEL_EXPORTER_UDP_ENDPOINT", "localhost:2000");
        ...
        return OpenTelemetrySdk.builder()
                ...
                .setTracerProvider(
                        SdkTracerProvider.builder()
                                .addSpanProcessor(
                                        BatchSpanProcessor.builder(new OtlpUdpSpanExporterBuilder().setEndpoint(udpExporter).build()).build())
